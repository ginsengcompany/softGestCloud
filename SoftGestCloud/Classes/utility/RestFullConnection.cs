...
namespace Utility
{
	public static class RestFullConnection
	{
		...
		public static readonly string LOGIN_LINK = "http://192.168.125.7:8080/AdvaSoftLogin/";//<--CASA
		public static readonly string APPLICATION_LINK = "http://192.168.125.7:8080/PubbliGestCloud/";//<--CASA		
